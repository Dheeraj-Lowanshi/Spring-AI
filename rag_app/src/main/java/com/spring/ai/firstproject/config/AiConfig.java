...
public class AiConfig {
    ...
    public ChatClient chatClient(ChatClient.Builder builder, ChatMemory chatMemory) {
        ...
        //MessageWindowChatMemory class use

        return builder
                .defaultAdvisors(messageChatMemoryAdvisor, new SimpleLoggerAdvisor(), new TokenPrintAdvisor(), new SafeGuardAdvisor(List.of("games")))
